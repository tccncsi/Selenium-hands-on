...
public class Practical_assess extends BaseClass{
	...
	public void Links() throws IOException {
		driver.get("https://www.youngandreckless.com/");
...
//		Checks if the ratio is 1 to ensure all the links were valid
	...
	/*
	 * @Test(enabled=false) public void add_products() { tillyshomepage = new
	 * TillysHP(driver); tillyssale = new TillysSale(driver);
	 * 
	 * // Clicks on Sale tab from Navbar tillyshomepage.click_nav_Sale();
	 * 
	 * // Fetches all the discounted text under mens section int max_disc_mens_index
	 * = tillyssale.get_max_discount_mens();
	 * 
