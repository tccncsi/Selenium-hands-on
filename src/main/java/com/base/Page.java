...
public abstract class Page {
	...
	public abstract int validateLinks(List<WebElement> ele) throws IOException;

	public abstract ArrayList<String> fetch_all_href(List<WebElement> element);
	
	public abstract ArrayList<String> fetch_all_text(List<WebElement> element);
	
	public abstract String convertDate(String date_con);
}
