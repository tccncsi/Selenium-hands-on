...
public class DeleteAssetTest extends BaseClass {
	...
	public void SerachAssets() throws NumberFormatException, IOException, InterruptedException {
		...
		AMSAssets.DeleteTheTopMostRecordAfterSearch(XLUtils.FetchExcelData("Asset"));
		AMSAssets.VerifyDataNotFoundMessageIsPresent(XLUtils.FetchExcelData("Asset"));
	}
}
